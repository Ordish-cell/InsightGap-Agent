...
class LLMSettings(BaseSettings):
    ...
    fast_model: str = Field("qwen3.6-max-preview", validation_alias="AGENT_FAST_MODEL")
    ...
    intent_model: str = Field("qwen3.6-max-preview", validation_alias="AGENT_INTENT_MODEL")
    safety_model: str = Field("qwen3.6-max-preview", validation_alias="AGENT_SAFETY_MODEL")
    ...
    memory_model: str = Field("qwen3.6-max-preview", validation_alias="AGENT_MEMORY_MODEL")
    skill_model: str = Field("qwen3.6-max-preview", validation_alias="AGENT_SKILL_MODEL")
