...
_ROUTE_WEIGHTS: dict[str, dict[str, float]] = {
    "chat": {
        "conversation_summary": 0.80, "memory": 0.75, "profile": 0.60,
        "task": 0.70, "feed_card": 0.50, "evidence": 0.35,
        "checkpoint_summary": 0.40, "dynamic_preferences": 0.65,
    },
    "feed": {
        "memory": 0.85, "dynamic_preferences": 0.80,
        "profile": 0.65, "conversation_summary": 0.30,
        "evidence": 0.45, "feed_card": 0.55, "task": 0.60,
    },
    "research": {
        "feed_card": 0.85, "evidence": 0.80, "memory": 0.65,
        "checkpoint_summary": 0.70, "conversation_summary": 0.55,
        "dynamic_preferences": 0.60, "task": 0.75, "profile": 0.50,
    },
    "rag": {
        "evidence": 0.90, "task": 0.75, "feed_card": 0.65,
        "memory": 0.55, "checkpoint_summary": 0.40,
    },
    "skill": {
        "memory": 0.80, "dynamic_preferences": 0.75,
        "conversation_summary": 0.65, "feed_card": 0.55,
        "evidence": 0.40, "checkpoint_summary": 0.50, "task": 0.70,
    },
    "artifact": {
        "dynamic_preferences": 0.85, "feed_card": 0.75,
        "memory": 0.65, "conversation_summary": 0.55,
        "evidence": 0.60, "checkpoint_summary": 0.50, "task": 0.70,
    },
    "tool": {
        "task": 0.80, "evidence": 0.70, "checkpoint_summary": 0.65,
