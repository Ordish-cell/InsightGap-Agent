...
export const testConnection = (payload: Record<string, unknown>) => apiRequest<{ status: string; model_id?: string; latency_ms?: number; persisted?: boolean; models: Array<{ model_id: string; display_name: string }> }>('/llm/connections/test', { method: 'POST', body: payload })
